...
public class HookScr : MonoBehaviour
{
    ...
    private HookMove hookMovement;

    private PlayerAnimation playerAnim;

    void Awake() {
        hookMovement = GetComponentInParent<HookMove>();
    ...
    void OnTriggerEnter2D(Collider2D target) {
        ...
        if(target.tag == Tags.DELIVER_ITEM) { 
            ...
            if(itemAttached) {
                ...
                GameplayManager2.instance.DisplayScore(scoreValue);
